import { MobxComponent } from '@we-app/core'
import { BaseStore } from "./base_store";
import { BaseApp } from './base_app';
import { EVENT } from '../common/const/eventList';
import { BaseServiceCore } from './base_service_core';

export class BaseComponent<S extends BaseStore = BaseStore, V extends BaseServiceCore = BaseServiceCore, D = IAnyObject> extends MobxComponent<D, S, BaseApp<S, V>, V> {
